...
add_action('theme/index/post/thumbnail', 'Alqatami\Theme\App\Structure\render_post_thumbnail');
...
add_action('theme/single/content', 'Alqatami\Theme\App\Structure\render_post_content');
...
add_action('theme/index/sidebar', 'Alqatami\Theme\App\Structure\render_sidebar');
add_action('theme/single/sidebar', 'Alqatami\Theme\App\Structure\render_sidebar');
...
add_action('theme/header/end', 'Alqatami\Theme\App\Structure\render_documentation_button');
