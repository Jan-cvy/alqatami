...
namespace Alqatami\Theme\App\Setup;
...
add_filter('theme/index/sidebar/visibility', 'Alqatami\Theme\App\Setup\show_index_sidebar');
add_filter('theme/single/sidebar/visibility', 'Alqatami\Theme\App\Setup\show_index_sidebar');
...
add_filter('excerpt_length', 'Alqatami\Theme\App\Setup\modify_excerpt_length');
